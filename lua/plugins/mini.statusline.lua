return {
  ...
  config = function()
    ...
    local function custom_diff()
      ...
      if add == 0 and change == 0 and delete == 0 then return '' end

      local str = ''
      if add > 0 then str = str .. '%#MiniDiffSignAdd#+' .. add .. ' ' end
      if change > 0 then str = str .. '%#MiniDiffSignChange#~' .. change .. ' ' end
      if delete > 0 then str = str .. '%#MiniDiffSignDelete#-' .. delete .. ' ' end
    ...
    local function custom_diagnostics()
      ...
      if errors == 0 and warns == 0 and infos == 0 and hints == 0 then return '' end

      local str = ''
      if errors > 0 then str = str .. '%#DiagnosticError#E:' .. errors .. ' ' end
      if warns > 0 then str = str .. '%#DiagnosticWarn#W:' .. warns .. ' ' end
      if infos > 0 then str = str .. '%#DiagnosticInfo#I:' .. infos .. ' ' end
      if hints > 0 then str = str .. '%#DiagnosticHint#H:' .. hints .. ' ' end
